<footer>
	<div class="container">
		<div class="row">
			...
			<li class="socialNetworkLI"><a href="3"><img src="<?php echo VIEWS;?>Images/SocialNetwork/linkedin-green.png" class="logoSocialNetwork" alt="logoLinkedIn"  width="35px"/></a>&nbsp;LinkedIn</li>
